...
\coordinate (Dropout_12-Embedding_9-1) at ($ (Dropout_12-padded-east) - (0,0,-34.0) $);
\coordinate (Dropout_12-Embedding_9-2) at ($ (Embedding_9-padded-west) - (0,0,-34.0) $);
...
\coordinate (Linear_13-LSTM_11-1) at ($ (Linear_13-padded-east) - (0,0,-34.0) $);
\coordinate (Linear_13-LSTM_11-2) at ($ (LSTM_11-padded-west) - (0,0,-34.0) $);
