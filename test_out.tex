...
\pic[shift={(1.6, 0.0, 0.0)}] at (Pool_2-east)
    {RightBandedBox={
        ...
        caption=Conv3,
        width=2.4,
        height=15.408464566929133,
        depth=15.408464566929133,
        bandfill=\ActivationColor,
        xlabel={32,},
        zlabel=62
        }
...
\pic[shift={(0.0, 0.0, 0.0)}] at (ConvAct_3-east)
    {Box={
        ...
        caption= ,
        width=1,
        height=9.641732283464567,
        depth=9.641732283464567
        }
    };
...
\pic[shift={(1.6, 0.0, 0.0)}] at (Pool_4-east)
    {RightBandedBox={
        ...
        caption=Conv5,
        width=2.4,
        height=5.144653289306579,
        depth=5.144653289306579,
        bandfill=\ActivationColor,
        xlabel={32,},
        zlabel=14
        }
...
\pic[shift={(0.0, 0.0, 0.0)}] at (ConvAct_5-east)
    {Box={
        ...
        caption= ,
        width=1,
        height=3.0098266446532893,
        depth=3.0098266446532893
        }
    };


\pic[shift={(0.0, 1.6, 0.0)}] at (Pool_6-east)
    {Box={
        name=VecInput_7,
        fill=\VecInputColor,
        opacity=0.7,
...
\pic[shift={(0.0, 1.6, 0.0)}] at (Embedding_9-east)
    {Box={
        name=VecInput_10,
        fill=\VecInputColor,
        opacity=0.7,
...
\coordinate (Dropout_12-Embedding_9-1) at ($ (Dropout_12-padded-east) - (0,0,-17.8) $);
\coordinate (Dropout_12-Embedding_9-2) at ($ (Embedding_9-padded-west) - (0,0,-17.8) $);
...
\coordinate (Linear_13-LSTM_11-1) at ($ (Linear_13-padded-east) - (0,0,-17.8) $);
\coordinate (Linear_13-LSTM_11-2) at ($ (LSTM_11-padded-west) - (0,0,-17.8) $);
