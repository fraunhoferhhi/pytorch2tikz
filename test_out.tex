...
\def\EdgeColor{rgb,255:red,170;green,170;blue,170}
...
\pic[shift={(0.0, 6.009448818897638, 0.0)}] at (Embedding_9-east)
    {Box={
        name=VecInput_10,
        fill=\VecInputColor,
        opacity=0.7,
...
\pic[shift={(3.2, 0.0, 0.0)}] at (Dropout_12-east)
    {Box={
        name=Linear_13,
        fill=\LinearColor,
        opacity=0.7,
...
\draw [connection] (VecInput_7-east) -- node {\midarrow} (Linear_8-west);
\draw [connection] (Embedding_9-east) -- node {\midarrow} (LSTM_11-west);
\draw [connection] (VecInput_10-east) -- node {\midarrow} (LSTM_11-west);

\path (Dropout_12-padded-neareast) -- (Dropout_12-padded-fareast) coordinate[pos=-2.204724409448819] (Dropout_12-nearnear);
\path (Embedding_9-padded-nearwest) -- (Embedding_9-padded-farwest) coordinate[pos=-2.204724409448819] (Embedding_9-nearnear);
\draw [connection]  (Dropout_12-east) -- (Dropout_12-padded-east) -- node {\midarrow}(Dropout_12-nearnear) -- node {\midarrow}(Embedding_9-nearnear) -- node {\midarrow}(Embedding_9-padded-west) -- (Embedding_9-west);

\draw [connection] (Embedding_9-east) -- node {\midarrow} (Linear_13-west);

\path (Linear_13-padded-neareast) -- (Linear_13-padded-fareast) coordinate[pos=-2.204724409448819] (Linear_13-nearnear);
\path (LSTM_11-padded-nearwest) -- (LSTM_11-padded-farwest) coordinate[pos=-2.204724409448819] (LSTM_11-nearnear);
\draw [connection]  (Linear_13-east) -- (Linear_13-padded-east) -- node {\midarrow}(Linear_13-nearnear) -- node {\midarrow}(LSTM_11-nearnear) -- node {\midarrow}(LSTM_11-padded-west) -- (LSTM_11-west);
