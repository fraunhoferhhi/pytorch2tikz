...
\path (Dropout_12-southeast) -- (Dropout_12-northeast) coordinate[pos=4.409448818897638] (Dropout_12-top) ;
\path (Embedding_9-south)  -- (Embedding_9-north)  coordinate[pos=4.409448818897638] (Embedding_9-top) ;
\draw [connection]  (Dropout_12-northeast) -- node {\midarrow}(Dropout_12-top) -- node {\midarrow}(Embedding_9-top) -- node {\midarrow}(Embedding_9-north);

\draw [connection] (Embedding_9-east) -- node {\midarrow} (Linear_13-west);

\path (Linear_13-southeast) -- (Linear_13-northeast) coordinate[pos=4.409448818897638] (Linear_13-top) ;
\path (LSTM_11-south)  -- (LSTM_11-north)  coordinate[pos=4.409448818897638] (LSTM_11-top) ;
\draw [connection]  (Linear_13-northeast) -- node {\midarrow}(Linear_13-top) -- node {\midarrow}(LSTM_11-top) -- node {\midarrow}(LSTM_11-north);
